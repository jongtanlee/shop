package com.smoothlife.shop.kafka.application;

import com.smoothlife.shop.kafka.dto.AsyncOrderDispatchResult;
import com.smoothlife.shop.kafka.dto.AsyncOrderEvent;
import com.smoothlife.shop.kafka.dto.AsyncOrderRequest;
...
public class AsyncOrderEventPublisher {
    ...
    public AsyncOrderEventPublisher(
            ...
            Clock clock,
            @Value("${kafka.topic.async-orders:async-orders}") String topicName // 카프카 등록
    ) {
