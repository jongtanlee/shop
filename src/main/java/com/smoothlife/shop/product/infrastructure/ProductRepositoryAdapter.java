...
import com.smoothlife.shop.product.domain.ProductRepository;
...
public class ProductRepositoryAdapter implements ProductRepository {
    ...
    @Override
    public Optional<Product> findById(UUID id) { return productJpaRepository.findById(id); }

    @Override
    public Product save(Product product) { return productJpaRepository.save(product); }

    @Override
    public void deleteById(UUID id) { productJpaRepository.deleteById(id); }
}
