package com.smoothlife.shop.member.presentation;

import com.smoothlife.shop.common.ResponseEntity;
import com.smoothlife.shop.member.application.dto.MemberInfo;
import com.smoothlife.shop.member.application.MemberService;
import com.smoothlife.shop.member.presentation.dto.MemberRequest;
...
public class MemberController {
    ...
    @PutMapping("{id}")
    public ResponseEntity<MemberInfo> update(MemberRequest request,  @PathVariable String id) {
